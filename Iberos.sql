...
CREATE TABLE reinado ( Nombre_regulo VARCHAR(40) NOT NULL ,  Nombre_tribu VARCHAR(40) NOT NULL , Año_inicio_reinado VARCHAR(10) NOT NULL , Año_fin_reinado VARCHAR(10) NOT NULL , PRIMARY KEY (Nombre_regulo, Nombre_tribu));
